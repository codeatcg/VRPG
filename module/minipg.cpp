...
//---------------
void GraphRange::splitRange(int rangeNum,unordered_map<string,int> &chrMap,unordered_map<string,int> &refChrMap,string &rndDxFile,string &rndFile,string &snFile){
...
void GraphRange::getNrefEdge(string &rndFile,vector<NEdge> &resEdge){
